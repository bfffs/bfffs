...
EXTERNAL_CRATES='(std|divbuf|fixedbitset|futures|isa_l|itertools|mio|mockers|modulo|permutohedron|nix|rand|serde|serde_cbor|super|tempdir|tokio|tokio_file|uuid)'
BORING_FILES='^\<(common)\>$'
