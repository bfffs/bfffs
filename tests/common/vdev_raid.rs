...
test_suite! {
    ...
    const GOLDEN_VDEV_RAID_LABEL: [u8; 223] = [
    ...
    test write_label(raid()) {
        ...
        for path in raid.val.2 {
            ...
            // fields
            assert_eq!(&v[0..27], &GOLDEN_VDEV_RAID_LABEL[0..27]);
            assert_eq!(&v[35..47], &GOLDEN_VDEV_RAID_LABEL[35..47]);
            assert_eq!(&v[63..138], &GOLDEN_VDEV_RAID_LABEL[63..138]);
