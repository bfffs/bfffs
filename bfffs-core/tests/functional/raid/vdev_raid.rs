...
mod persistence {
    ...
    const GOLDEN_VDEV_RAID_LABEL: [u8; 120] = [
        ...
        0x00, 0x00, 0x00, 0x00,
        // Vector of children's UUIDs.  A 32-bit count of children, then each
        // UUID is 64-bits long
                                0x05, 0x00, 0x00, 0x00,
        0x2c, 0x9a, 0x3b, 0xfd, 0x9c, 0xaf, 0x4c, 0xf8,
        ...
        0x24, 0x31, 0xb8, 0x32, 0x01, 0x63, 0x45, 0xd5,
        0xa7, 0x9c, 0xec, 0x10, 0x6b, 0xfe, 0x9b, 0x7c,
        0xb8, 0x79, 0x31, 0x82, 0x2f, 0xc9, 0x4c, 0x40,
        0x84, 0xd3, 0xff, 0xd5, 0xb8, 0x3b, 0x18, 0x8e,
    ];
    ...
    async fn write_label(#[future] harness: Harness) {
        ...
        for path in harness.paths {
            ...
            assert_eq!(&v[20..40], &GOLDEN_VDEV_RAID_LABEL[20..40]);
