...
test_suite! {
    ...
    const GOLDEN_DB_LABEL: [u8; 144] = [
        ...
        0x18, 0x62, 0x6e, 0x6d, 0x61, 0x78, 0x5f, 0x69, // ..nmax_i
        0x6e, 0x74, 0x5f, 0x66, 0x61, 0x6e, 0x6f, 0x75, // nt_fanou
        0x74, 0x19, 0x01, 0x85, 0x6f, 0x6d, 0x69, 0x6e, // t...omin
        0x5f, 0x6c, 0x65, 0x61, 0x66, 0x5f, 0x66, 0x61, // _leaf_fa
        0x6e, 0x6f, 0x75, 0x74, 0x18, 0x72, 0x6f, 0x6d, // nout.rom
        0x61, 0x78, 0x5f, 0x6c, 0x65, 0x61, 0x66, 0x5f, // ax_leaf_
        0x66, 0x61, 0x6e, 0x6f, 0x75, 0x74, 0x19, 0x01, // fanout..
        0xc6, 0x69, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x73, // .i_max_s
        0x69, 0x7a, 0x65, 0x1a, 0x00, 0x40, 0x00, 0x00, // ize..@..
        0x64, 0x72, 0x6f, 0x6f, 0x74, 0x00, 0x64, 0x74, // droot.dt
        0x78, 0x67, 0x73, 0xa2, 0x65, 0x73, 0x74, 0x61, // xgs.esta
        0x72, 0x74, 0x00, 0x63, 0x65, 0x6e, 0x64, 0x01, // rt.cend.
    ...
    test sync_transaction(objects()) {
        ...
        f.seek(SeekFrom::Start(0x2b6)).unwrap();
