...
test_suite! {
    ...
    test sync_transaction(objects()) {
        ...
        f.seek(SeekFrom::Start(0x2b2)).unwrap();
        ...
        assert_eq!(&v[0..144], &GOLDEN_DB_LABEL[0..144]);
        // Rest of the buffer should be zero-filled
        assert!(v[144..].iter().all(|&x| x == 0));
    }
}
