...
test_suite! {
    ...
    const GOLDEN_DB_LABEL: [u8; 104] = [
        ...
        0x66, 0x66, 0x6f, 0x72, 0x65, 0x73, 0x74, 0xa4, // fforest.
        ...
        0xa3, 0x63, 0x6b, 0x65, 0x79, 0x82, 0x62, 0x46, // .ckey.bF
        0x73, 0x00, 0x64, 0x74, 0x78, 0x67, 0x73, 0xa2, // s.dtxgs.
        0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x00, 0x63, // estart.c
        0x65, 0x6e, 0x64, 0x01, 0x63, 0x70, 0x74, 0x72, // end.cptr
        0x82, 0x64, 0x41, 0x64, 0x64, 0x72, 0x00, 0x00, // .dAddr..
    ...
    test sync_transaction(objects()) {
        ...
        f.seek(SeekFrom::Start(0x276)).unwrap();
