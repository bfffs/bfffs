...
test_suite! {
    ...
    const GOLDEN_DB_LABEL: [u8; 88] = [
        ...
        0xa2, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, // .estart.
        0x63, 0x65, 0x6e, 0x64, 0x18, 0x49, 0x69, 0x5f, // cend.Ii_
    ...
    test sync_transaction(objects()) {
        ...
        f.seek(SeekFrom::Start(0x24c)).unwrap();
        ...
        assert_eq!(&v[0..88], &GOLDEN_DB_LABEL[0..88]);
        // Rest of the buffer should be zero-filled
        assert!(v[88..].iter().all(|&x| x == 0));
    }
}
