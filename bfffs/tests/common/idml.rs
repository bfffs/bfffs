...
test_suite! {
    ...
    const GOLDEN_IDML_LABEL: [u8; 336] = [
        ...
        0x6e, 0x6f, 0x75, 0x74, 0x18, 0x4c, 0x6a, 0x6d, // nout.Ljm
        0x61, 0x78, 0x5f, 0x66, 0x61, 0x6e, 0x6f, 0x75, // ax_fanou
        0x74, 0x19, 0x01, 0x2e, 0x69, 0x5f, 0x6d, 0x61, // t...i_ma
        0x78, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x1a, 0x00, // x_size..
        0x40, 0x00, 0x00, 0x64, 0x72, 0x6f, 0x6f, 0x74, // @..droot
        0xa5, 0x63, 0x70, 0x62, 0x61, 0xa2, 0x67, 0x63, // .cpba.gc
        0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x00, 0x63, // luster.c
        0x6c, 0x62, 0x61, 0x0a, 0x6a, 0x63, 0x6f, 0x6d, // lba.jcom
        0x70, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0xf4, // pressed.
        0x65, 0x6c, 0x73, 0x69, 0x7a, 0x65, 0x0c, 0x65, // elsize.e
        0x63, 0x73, 0x69, 0x7a, 0x65, 0x0c, 0x68, 0x63, // csize.hc
        0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x1b, // hecksum.
        0x69, 0xea, 0x4d, 0xa2, 0x4c, 0xe3, 0xfa, 0x9f, // i.M.L...
        0x64, 0x74, 0x78, 0x67, 0x73, 0xa2, 0x65, 0x73, // dtxgs.es
        0x74, 0x61, 0x72, 0x74, 0x18, 0x2a, 0x63, 0x65, // tart.*ce
        0x6e, 0x64, 0x18, 0x2b, 0x68, 0x6e, 0x65, 0x78, // nd.+hnex
        0x74, 0x5f, 0x72, 0x69, 0x64, 0x00, 0x64, 0x72, // t_rid.dr
        0x69, 0x64, 0x74, 0xa4, 0x66, 0x68, 0x65, 0x69, // idt.fhei
        0x67, 0x68, 0x74, 0x01, 0x66, 0x6c, 0x69, 0x6d, // ght.flim
        0x69, 0x74, 0x73, 0xa3, 0x6a, 0x6d, 0x69, 0x6e, // its.jmin
        0x5f, 0x66, 0x61, 0x6e, 0x6f, 0x75, 0x74, 0x18, // _fanout.
        0x20, 0x6a, 0x6d, 0x61, 0x78, 0x5f, 0x66, 0x61, //  jmax_fa
        0x6e, 0x6f, 0x75, 0x74, 0x18, 0x7e, 0x69, 0x5f, // nout.~i_
        0x6d, 0x61, 0x78, 0x5f, 0x73, 0x69, 0x7a, 0x65, // max_size
        0x1a, 0x00, 0x40, 0x00, 0x00, 0x64, 0x72, 0x6f, // ..@..dro
        0x6f, 0x74, 0xa5, 0x63, 0x70, 0x62, 0x61, 0xa2, // ot.cpba.
        0x67, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, // gcluster
        0x00, 0x63, 0x6c, 0x62, 0x61, 0x0b, 0x6a, 0x63, // .clba.jc
        0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x65, // ompresse
        0x64, 0xf4, 0x65, 0x6c, 0x73, 0x69, 0x7a, 0x65, // d.elsize
        0x0c, 0x65, 0x63, 0x73, 0x69, 0x7a, 0x65, 0x0c, // .ecsize.
        0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, // hchecksu
        0x6d, 0x1b, 0x69, 0xea, 0x4d, 0xa2, 0x4c, 0xe3, // m.i.M.L.
        0xfa, 0x9f, 0x64, 0x74, 0x78, 0x67, 0x73, 0xa2, // ..dtxgs.
        0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x2a, // estart.*
        0x63, 0x65, 0x6e, 0x64, 0x18, 0x2b, 0x63, 0x74, // cend.+ct
        0x78, 0x67, 0x18, 0x2a, 0x00, 0x00, 0x00, 0x00, // xg.*....
    ...
    test write_label(objects()) {
        ...
        assert_eq!(&v[0..336], &GOLDEN_IDML_LABEL[0..336]);
        // Rest of the buffer should be zero-filled
        assert!(v[336..].iter().all(|&x| x == 0));
    }
}
