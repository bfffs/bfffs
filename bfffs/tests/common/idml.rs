...
test_suite! {
    ...
    const GOLDEN_IDML_LABEL: [u8; 360] = [
        ...
        0xa2, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x04, // .estart.
        0x63, 0x65, 0x6e, 0x64, 0x11, 0x69, 0x5f, 0x6d, // cend.i_m
        0x61, 0x78, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x1a, // ax_size.
        0x00, 0x40, 0x00, 0x00, 0x64, 0x72, 0x6f, 0x6f, // .@..droo
        0x74, 0xa3, 0x63, 0x6b, 0x65, 0x79, 0xa2, 0x67, // t.ckey.g
        0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x00, // cluster.
        0x63, 0x6c, 0x62, 0x61, 0x00, 0x64, 0x74, 0x78, // clba.dtx
        0x67, 0x73, 0xa2, 0x65, 0x73, 0x74, 0x61, 0x72, // gs.estar
        0x74, 0x18, 0x2a, 0x63, 0x65, 0x6e, 0x64, 0x18, // t.*cend.
        0x2b, 0x63, 0x70, 0x74, 0x72, 0x82, 0x64, 0x41, // +cptr.dA
        0x64, 0x64, 0x72, 0xa5, 0x63, 0x70, 0x62, 0x61, // ddr.cpba
        ...
        0x68, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x72, 0x69, // hnext_ri
        0x64, 0x00, 0x64, 0x72, 0x69, 0x64, 0x74, 0xa4, // d.dridt.
        0x66, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x01, // fheight.
        0x66, 0x66, 0x61, 0x6e, 0x6f, 0x75, 0x74, 0xa2, // ffanout.
        0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x04, 0x63, // estart.c
        0x65, 0x6e, 0x64, 0x11, 0x69, 0x5f, 0x6d, 0x61, // end.i_ma
        0x78, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x1a, 0x00, // x_size..
        0x40, 0x00, 0x00, 0x64, 0x72, 0x6f, 0x6f, 0x74, // @..droot
        0xa3, 0x63, 0x6b, 0x65, 0x79, 0x00, 0x64, 0x74, // .ckey.dt
        0x78, 0x67, 0x73, 0xa2, 0x65, 0x73, 0x74, 0x61, // xgs.esta
        0x72, 0x74, 0x18, 0x2a, 0x63, 0x65, 0x6e, 0x64, // rt.*cend
        0x18, 0x2b, 0x63, 0x70, 0x74, 0x72, 0x82, 0x64, // .+cptr.d
        0x41, 0x64, 0x64, 0x72, 0xa5, 0x63, 0x70, 0x62, // Addr.cpb
        0x61, 0xa2, 0x67, 0x63, 0x6c, 0x75, 0x73, 0x74, // a.gclust
        0x65, 0x72, 0x00, 0x63, 0x6c, 0x62, 0x61, 0x0b, // er.clba.
        ...
        0x9f, 0x63, 0x74, 0x78, 0x67, 0x18, 0x2a, 0x00, // .ctxg.*.
    ...
    test write_label(objects()) {
        ...
        // fields
        assert_eq!(&v[0..360], &GOLDEN_IDML_LABEL[0..360]);
        // Rest of the buffer should be zero-filled
        assert!(v[360..].iter().all(|&x| x == 0));
    }
}
