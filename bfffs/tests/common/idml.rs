...
test_suite! {
    ...
    const GOLDEN_IDML_LABEL: [u8; 312] = [
        ...
        0x64, 0x00, 0x64, 0x72, 0x69, 0x64, 0x74, 0xa5, // d.dridt.
        0x66, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x01, // fheight.
        0x66, 0x66, 0x61, 0x6e, 0x6f, 0x75, 0x74, 0xa2, // ffanout.
        0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x20, // estart. 
        0x63, 0x65, 0x6e, 0x64, 0x18, 0x7f, 0x69, 0x5f, // cend..i_
    ...
    test write_label(objects()) {
        ...
        assert_eq!(&v[0..312], &GOLDEN_IDML_LABEL[0..312]);
        // Rest of the buffer should be zero-filled
        assert!(v[312..].iter().all(|&x| x == 0));
    }
}
