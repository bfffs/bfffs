...
pub const FIO_IOOPS_VERSION: u32 = 39;
...
pub const fio_ddir_DDIR_SYNCFS: fio_ddir = 6;
pub const fio_ddir_DDIR_WAIT: fio_ddir = 7;
pub const fio_ddir_DDIR_LAST: fio_ddir = 8;
...
pub const fio_filetype_FIO_TYPE_DIR: fio_filetype = 5;
...
pub struct fio_file {
    ...
    pub min_zone:         u32,
    pub max_zone:         u32,
    pub spr_info:         *mut sprandom_info,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of fio_file"][::std::mem::size_of::<fio_file>() - 384usize];
    ...
    ["Offset of field: fio_file::spr_info"]
        [::std::mem::offset_of!(fio_file, spr_info) - 104usize];
    ["Offset of field: fio_file::last_pos"]
        [::std::mem::offset_of!(fio_file, last_pos) - 112usize];
    ["Offset of field: fio_file::last_start"]
        [::std::mem::offset_of!(fio_file, last_start) - 136usize];
    ["Offset of field: fio_file::first_write"]
        [::std::mem::offset_of!(fio_file, first_write) - 160usize];
    ["Offset of field: fio_file::last_write"]
        [::std::mem::offset_of!(fio_file, last_write) - 168usize];
    ["Offset of field: fio_file::engine_pos"]
        [::std::mem::offset_of!(fio_file, engine_pos) - 176usize];
    ["Offset of field: fio_file::engine_data"]
        [::std::mem::offset_of!(fio_file, engine_data) - 184usize];
    ["Offset of field: fio_file::references"]
        [::std::mem::offset_of!(fio_file, references) - 368usize];
    ["Offset of field: fio_file::flags"]
        [::std::mem::offset_of!(fio_file, flags) - 372usize];
    ["Offset of field: fio_file::du"]
        [::std::mem::offset_of!(fio_file, du) - 376usize];
};
pub type os_aiocb_t = __BindgenOpaqueArray<u64, 20usize>;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of io_u"][::std::mem::size_of::<io_u>() - 392usize];
    ...
    ["Offset of field: io_u::numberio"]
        [::std::mem::offset_of!(io_u, numberio) - 56usize];
    ["Offset of field: io_u::ioprio"]
        [::std::mem::offset_of!(io_u, ioprio) - 64usize];
    ["Offset of field: io_u::clat_prio_index"]
        [::std::mem::offset_of!(io_u, clat_prio_index) - 66usize];
    ["Offset of field: io_u::number_trim"]
        [::std::mem::offset_of!(io_u, number_trim) - 68usize];
    ["Offset of field: io_u::buflen"]
        [::std::mem::offset_of!(io_u, buflen) - 72usize];
    ["Offset of field: io_u::offset"]
        [::std::mem::offset_of!(io_u, offset) - 80usize];
    ["Offset of field: io_u::verify_offset"]
        [::std::mem::offset_of!(io_u, verify_offset) - 88usize];
    ["Offset of field: io_u::buf"][::std::mem::offset_of!(io_u, buf) - 96usize];
    ["Offset of field: io_u::rand_seed"]
        [::std::mem::offset_of!(io_u, rand_seed) - 104usize];
    ["Offset of field: io_u::xfer_buf"]
        [::std::mem::offset_of!(io_u, xfer_buf) - 112usize];
    ["Offset of field: io_u::xfer_buflen"]
        [::std::mem::offset_of!(io_u, xfer_buflen) - 120usize];
    ["Offset of field: io_u::buf_filled_len"]
        [::std::mem::offset_of!(io_u, buf_filled_len) - 128usize];
    ["Offset of field: io_u::ipo"]
        [::std::mem::offset_of!(io_u, ipo) - 136usize];
    ["Offset of field: io_u::resid"]
        [::std::mem::offset_of!(io_u, resid) - 144usize];
    ["Offset of field: io_u::error"]
        [::std::mem::offset_of!(io_u, error) - 152usize];
    ["Offset of field: io_u::inflight_idx"]
        [::std::mem::offset_of!(io_u, inflight_idx) - 156usize];
    ["Offset of field: io_u::engine_data"]
        [::std::mem::offset_of!(io_u, engine_data) - 168usize];
    ["Offset of field: io_u::zbd_queue_io"]
        [::std::mem::offset_of!(io_u, zbd_queue_io) - 192usize];
    ["Offset of field: io_u::zbd_put_io"]
        [::std::mem::offset_of!(io_u, zbd_put_io) - 200usize];
    ["Offset of field: io_u::end_io"]
        [::std::mem::offset_of!(io_u, end_io) - 208usize];
    ["Offset of field: io_u::dtype"]
        [::std::mem::offset_of!(io_u, dtype) - 216usize];
    ["Offset of field: io_u::dspec"]
        [::std::mem::offset_of!(io_u, dspec) - 220usize];
    ["Offset of field: io_u::pi_attr"]
        [::std::mem::offset_of!(io_u, pi_attr) - 384usize];
};
...
pub struct ioengine_ops {
    ...
    >,
    pub move_zone_wp: ::std::option::Option<
        unsafe extern "C" fn(
            arg1: *mut thread_data,
            arg2: *mut fio_file,
            arg3: *mut zbd_zone,
...
const _: () = {
    ...
    ["Offset of field: ioengine_ops::cleanup"]
        [::std::mem::offset_of!(ioengine_ops, cleanup) - 112usize];
    ["Offset of field: ioengine_ops::open_file"]
        [::std::mem::offset_of!(ioengine_ops, open_file) - 120usize];
    ["Offset of field: ioengine_ops::close_file"]
        [::std::mem::offset_of!(ioengine_ops, close_file) - 128usize];
    ["Offset of field: ioengine_ops::invalidate"]
        [::std::mem::offset_of!(ioengine_ops, invalidate) - 136usize];
    ["Offset of field: ioengine_ops::unlink_file"]
        [::std::mem::offset_of!(ioengine_ops, unlink_file) - 144usize];
    ["Offset of field: ioengine_ops::get_file_size"]
        [::std::mem::offset_of!(ioengine_ops, get_file_size) - 152usize];
    ["Offset of field: ioengine_ops::prepopulate_file"]
        [::std::mem::offset_of!(ioengine_ops, prepopulate_file) - 160usize];
    ["Offset of field: ioengine_ops::terminate"]
        [::std::mem::offset_of!(ioengine_ops, terminate) - 168usize];
    ["Offset of field: ioengine_ops::iomem_alloc"]
        [::std::mem::offset_of!(ioengine_ops, iomem_alloc) - 176usize];
    ["Offset of field: ioengine_ops::iomem_free"]
        [::std::mem::offset_of!(ioengine_ops, iomem_free) - 184usize];
    ["Offset of field: ioengine_ops::io_u_init"]
        [::std::mem::offset_of!(ioengine_ops, io_u_init) - 192usize];
    ["Offset of field: ioengine_ops::io_u_free"]
        [::std::mem::offset_of!(ioengine_ops, io_u_free) - 200usize];
    ["Offset of field: ioengine_ops::get_zoned_model"]
        [::std::mem::offset_of!(ioengine_ops, get_zoned_model) - 208usize];
    ["Offset of field: ioengine_ops::report_zones"]
        [::std::mem::offset_of!(ioengine_ops, report_zones) - 216usize];
    ["Offset of field: ioengine_ops::reset_wp"]
        [::std::mem::offset_of!(ioengine_ops, reset_wp) - 224usize];
    ["Offset of field: ioengine_ops::move_zone_wp"]
        [::std::mem::offset_of!(ioengine_ops, move_zone_wp) - 232usize];
...
pub const fio_ioengine_flags_FIO_ASYNCIO_SYNC_SYNCFS: fio_ioengine_flags =
    32768;
pub const fio_ioengine_flags_FIO_NO_OFFLOAD: fio_ioengine_flags = 65536;
...
pub const fio_ioengine_flags_FIO_SKIPPABLE_IOMEM_ALLOC: fio_ioengine_flags =
    262144;
pub const fio_ioengine_flags_FIO_RO_NEEDS_RW_OPEN: fio_ioengine_flags = 524288;
pub const fio_ioengine_flags_FIO_MULTI_RANGE_TRIM: fio_ioengine_flags = 1048576;
pub const fio_ioengine_flags_FIO_ATOMICWRITES: fio_ioengine_flags = 2097152;
pub const fio_ioengine_flags_FIO_SYNCFS: fio_ioengine_flags = 4194304;
...
pub struct thread_stat {
    pub _bindgen_opaque_blob: [u64; 22988usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub union thread_stat__bindgen_ty_4 {
    pub ss_lat_data:        *mut u64,
    pub ss_lat_data_offset: u64,
    pub pad5b:              u64,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_stat__bindgen_ty_4"]
        [::std::mem::size_of::<thread_stat__bindgen_ty_4>() - 8usize];
    ["Alignment of thread_stat__bindgen_ty_4"]
        [::std::mem::align_of::<thread_stat__bindgen_ty_4>() - 8usize];
    ["Offset of field: thread_stat__bindgen_ty_4::ss_lat_data"][::std::mem::offset_of!(
        thread_stat__bindgen_ty_4,
        ss_lat_data
    ) - 0usize];
    ["Offset of field: thread_stat__bindgen_ty_4::ss_lat_data_offset"][::std::mem::offset_of!(
        thread_stat__bindgen_ty_4,
        ss_lat_data_offset
    ) -
        0usize];
    ["Offset of field: thread_stat__bindgen_ty_4::pad5b"]
        [::std::mem::offset_of!(thread_stat__bindgen_ty_4, pad5b) - 0usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
pub union thread_stat__bindgen_ty_5 {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_stat__bindgen_ty_5"]
        [::std::mem::size_of::<thread_stat__bindgen_ty_5>() - 24usize];
    ["Alignment of thread_stat__bindgen_ty_5"]
        [::std::mem::align_of::<thread_stat__bindgen_ty_5>() - 8usize];
    ["Offset of field: thread_stat__bindgen_ty_5::clat_prio"]
        [::std::mem::offset_of!(thread_stat__bindgen_ty_5, clat_prio) - 0usize];
    ["Offset of field: thread_stat__bindgen_ty_5::clat_prio_offset"][::std::mem::offset_of!(
        thread_stat__bindgen_ty_5,
        clat_prio_offset
    ) -
        0usize];
    ["Offset of field: thread_stat__bindgen_ty_5::pad6"]
        [::std::mem::offset_of!(thread_stat__bindgen_ty_5, pad6) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_stat"][::std::mem::size_of::<thread_stat>() - 183904usize];
...
pub struct thread_options {
    pub _bindgen_opaque_blob: [u64; 445usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_options"]
        [::std::mem::size_of::<thread_options>() - 3560usize];
...
const _: () = {
    ["Size of steadystate_data"]
        [::std::mem::size_of::<steadystate_data>() - 176usize];
...
pub struct thread_data {
    ...
    pub sprandom_state: frand_state,
    ...
    pub loops: u64,
    pub inflight_numberio: *mut u64,
    pub next_inflight_numberio_idx: libc::c_uint,
    pub inflight_issued: u64,
    ...
    pub ramp_period_state: libc::c_uint,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_data"][::std::mem::size_of::<thread_data>() - 191360usize];
    ...
    ["Offset of field: thread_data::eo"]
        [::std::mem::offset_of!(thread_data, eo) - 3584usize];
    ["Offset of field: thread_data::thread"]
        [::std::mem::offset_of!(thread_data, thread) - 3592usize];
    ["Offset of field: thread_data::thread_number"]
        [::std::mem::offset_of!(thread_data, thread_number) - 3600usize];
    ["Offset of field: thread_data::subjob_number"]
        [::std::mem::offset_of!(thread_data, subjob_number) - 3604usize];
    ["Offset of field: thread_data::groupid"]
        [::std::mem::offset_of!(thread_data, groupid) - 3608usize];
    ["Offset of field: thread_data::ts"]
        [::std::mem::offset_of!(thread_data, ts) - 3616usize];
    ["Offset of field: thread_data::client_type"]
        [::std::mem::offset_of!(thread_data, client_type) - 187520usize];
    ["Offset of field: thread_data::slat_log"]
        [::std::mem::offset_of!(thread_data, slat_log) - 187528usize];
    ["Offset of field: thread_data::clat_log"]
        [::std::mem::offset_of!(thread_data, clat_log) - 187536usize];
    ["Offset of field: thread_data::clat_hist_log"]
        [::std::mem::offset_of!(thread_data, clat_hist_log) - 187544usize];
    ["Offset of field: thread_data::lat_log"]
        [::std::mem::offset_of!(thread_data, lat_log) - 187552usize];
    ["Offset of field: thread_data::bw_log"]
        [::std::mem::offset_of!(thread_data, bw_log) - 187560usize];
    ["Offset of field: thread_data::iops_log"]
        [::std::mem::offset_of!(thread_data, iops_log) - 187568usize];
    ["Offset of field: thread_data::log_compress_wq"]
        [::std::mem::offset_of!(thread_data, log_compress_wq) - 187576usize];
    ["Offset of field: thread_data::parent"]
        [::std::mem::offset_of!(thread_data, parent) - 187720usize];
    ["Offset of field: thread_data::stat_io_bytes"]
        [::std::mem::offset_of!(thread_data, stat_io_bytes) - 187728usize];
    ["Offset of field: thread_data::bw_sample_time"]
        [::std::mem::offset_of!(thread_data, bw_sample_time) - 187752usize];
    ["Offset of field: thread_data::stat_io_blocks"]
        [::std::mem::offset_of!(thread_data, stat_io_blocks) - 187768usize];
    ["Offset of field: thread_data::iops_sample_time"]
        [::std::mem::offset_of!(thread_data, iops_sample_time) - 187792usize];
    ["Offset of field: thread_data::update_rusage"]
        [::std::mem::offset_of!(thread_data, update_rusage) - 187808usize];
    ["Offset of field: thread_data::rusage_sem"]
        [::std::mem::offset_of!(thread_data, rusage_sem) - 187816usize];
    ["Offset of field: thread_data::ru_start"]
        [::std::mem::offset_of!(thread_data, ru_start) - 187824usize];
    ["Offset of field: thread_data::ru_end"]
        [::std::mem::offset_of!(thread_data, ru_end) - 187968usize];
    ["Offset of field: thread_data::fs_list"]
        [::std::mem::offset_of!(thread_data, fs_list) - 188112usize];
    ["Offset of field: thread_data::files"]
        [::std::mem::offset_of!(thread_data, files) - 188128usize];
    ["Offset of field: thread_data::file_locks"]
        [::std::mem::offset_of!(thread_data, file_locks) - 188136usize];
    ["Offset of field: thread_data::files_size"]
        [::std::mem::offset_of!(thread_data, files_size) - 188144usize];
    ["Offset of field: thread_data::files_index"]
        [::std::mem::offset_of!(thread_data, files_index) - 188148usize];
    ["Offset of field: thread_data::nr_open_files"]
        [::std::mem::offset_of!(thread_data, nr_open_files) - 188152usize];
    ["Offset of field: thread_data::nr_done_files"]
        [::std::mem::offset_of!(thread_data, nr_done_files) - 188156usize];
    ["Offset of field: thread_data::random_center"]
        [::std::mem::offset_of!(thread_data, random_center) - 188320usize];
    ["Offset of field: thread_data::error"]
        [::std::mem::offset_of!(thread_data, error) - 188328usize];
    ["Offset of field: thread_data::sig"]
        [::std::mem::offset_of!(thread_data, sig) - 188332usize];
    ["Offset of field: thread_data::done"]
        [::std::mem::offset_of!(thread_data, done) - 188336usize];
    ["Offset of field: thread_data::stop_io"]
        [::std::mem::offset_of!(thread_data, stop_io) - 188340usize];
    ["Offset of field: thread_data::pid"]
        [::std::mem::offset_of!(thread_data, pid) - 188344usize];
    ["Offset of field: thread_data::orig_buffer"]
        [::std::mem::offset_of!(thread_data, orig_buffer) - 188352usize];
    ["Offset of field: thread_data::orig_buffer_size"]
        [::std::mem::offset_of!(thread_data, orig_buffer_size) - 188360usize];
    ["Offset of field: thread_data::runstate"]
        [::std::mem::offset_of!(thread_data, runstate) - 188368usize];
    ["Offset of field: thread_data::terminate"]
        [::std::mem::offset_of!(thread_data, terminate) - 188372usize];
    ["Offset of field: thread_data::last_ddir_completed"][::std::mem::offset_of!(
        thread_data,
        last_ddir_completed
    ) - 188376usize];
    ["Offset of field: thread_data::last_ddir_issued"]
        [::std::mem::offset_of!(thread_data, last_ddir_issued) - 188380usize];
    ["Offset of field: thread_data::mmapfd"]
        [::std::mem::offset_of!(thread_data, mmapfd) - 188384usize];
    ["Offset of field: thread_data::iolog_buf"]
        [::std::mem::offset_of!(thread_data, iolog_buf) - 188392usize];
    ["Offset of field: thread_data::iolog_f"]
        [::std::mem::offset_of!(thread_data, iolog_f) - 188400usize];
    ["Offset of field: thread_data::rand_seeds"]
        [::std::mem::offset_of!(thread_data, rand_seeds) - 188408usize];
    ["Offset of field: thread_data::bsrange_state"]
        [::std::mem::offset_of!(thread_data, bsrange_state) - 188592usize];
    ["Offset of field: thread_data::verify_state"]
        [::std::mem::offset_of!(thread_data, verify_state) - 188736usize];
    ...
    ["Offset of field: thread_data::trim_state"]
        [::std::mem::offset_of!(thread_data, trim_state) - 188832usize];
    ["Offset of field: thread_data::delay_state"]
        [::std::mem::offset_of!(thread_data, delay_state) - 188880usize];
    ["Offset of field: thread_data::fdp_state"]
        [::std::mem::offset_of!(thread_data, fdp_state) - 188928usize];
    ["Offset of field: thread_data::buf_state"]
        [::std::mem::offset_of!(thread_data, buf_state) - 188976usize];
    ["Offset of field: thread_data::buf_state_prev"]
        [::std::mem::offset_of!(thread_data, buf_state_prev) - 189024usize];
    ["Offset of field: thread_data::buf_state_ret"]
        [::std::mem::offset_of!(thread_data, buf_state_ret) - 189072usize];
    ["Offset of field: thread_data::dedupe_state"]
        [::std::mem::offset_of!(thread_data, dedupe_state) - 189120usize];
    ["Offset of field: thread_data::zone_state"]
        [::std::mem::offset_of!(thread_data, zone_state) - 189168usize];
    ["Offset of field: thread_data::prio_state"]
        [::std::mem::offset_of!(thread_data, prio_state) - 189216usize];
    ...
    ["Offset of field: thread_data::dedupe_working_set_states"][::std::mem::offset_of!(
        ...
        189312usize];
    ["Offset of field: thread_data::sprandom_state"]
        [::std::mem::offset_of!(thread_data, sprandom_state) - 189320usize];
    ["Offset of field: thread_data::num_unique_pages"]
        [::std::mem::offset_of!(thread_data, num_unique_pages) - 189368usize];
    ["Offset of field: thread_data::zone_state_index"]
        [::std::mem::offset_of!(thread_data, zone_state_index) - 189376usize];
    ["Offset of field: thread_data::num_write_zones"]
        [::std::mem::offset_of!(thread_data, num_write_zones) - 189384usize];
    ["Offset of field: thread_data::verify_batch"]
        [::std::mem::offset_of!(thread_data, verify_batch) - 189388usize];
    ["Offset of field: thread_data::trim_batch"]
        [::std::mem::offset_of!(thread_data, trim_batch) - 189392usize];
    ["Offset of field: thread_data::trim_verify"]
        [::std::mem::offset_of!(thread_data, trim_verify) - 189396usize];
    ["Offset of field: thread_data::vstate"]
        [::std::mem::offset_of!(thread_data, vstate) - 189400usize];
    ["Offset of field: thread_data::shm_id"]
        [::std::mem::offset_of!(thread_data, shm_id) - 189408usize];
    ["Offset of field: thread_data::ioprio"]
        [::std::mem::offset_of!(thread_data, ioprio) - 189412usize];
    ["Offset of field: thread_data::io_ops"]
        [::std::mem::offset_of!(thread_data, io_ops) - 189416usize];
    ["Offset of field: thread_data::io_ops_init"]
        [::std::mem::offset_of!(thread_data, io_ops_init) - 189424usize];
    ["Offset of field: thread_data::io_ops_data"]
        [::std::mem::offset_of!(thread_data, io_ops_data) - 189432usize];
    ["Offset of field: thread_data::cur_depth"]
        [::std::mem::offset_of!(thread_data, cur_depth) - 189440usize];
    ["Offset of field: thread_data::io_u_queued"]
        [::std::mem::offset_of!(thread_data, io_u_queued) - 189444usize];
    ["Offset of field: thread_data::io_u_in_flight"]
        [::std::mem::offset_of!(thread_data, io_u_in_flight) - 189448usize];
    ["Offset of field: thread_data::io_u_requeues"]
        [::std::mem::offset_of!(thread_data, io_u_requeues) - 189456usize];
    ["Offset of field: thread_data::io_u_freelist"]
        [::std::mem::offset_of!(thread_data, io_u_freelist) - 189480usize];
    ["Offset of field: thread_data::io_u_all"]
        [::std::mem::offset_of!(thread_data, io_u_all) - 189496usize];
    ["Offset of field: thread_data::io_u_lock"]
        [::std::mem::offset_of!(thread_data, io_u_lock) - 189512usize];
    ["Offset of field: thread_data::free_cond"]
        [::std::mem::offset_of!(thread_data, free_cond) - 189520usize];
    ["Offset of field: thread_data::verify_list"]
        [::std::mem::offset_of!(thread_data, verify_list) - 189528usize];
    ["Offset of field: thread_data::verify_threads"]
        [::std::mem::offset_of!(thread_data, verify_threads) - 189544usize];
    ["Offset of field: thread_data::nr_verify_threads"]
        [::std::mem::offset_of!(thread_data, nr_verify_threads) - 189552usize];
    ["Offset of field: thread_data::verify_cond"]
        [::std::mem::offset_of!(thread_data, verify_cond) - 189560usize];
    ["Offset of field: thread_data::verify_thread_exit"]
        [::std::mem::offset_of!(thread_data, verify_thread_exit) - 189568usize];
    ["Offset of field: thread_data::rate_bps"]
        [::std::mem::offset_of!(thread_data, rate_bps) - 189576usize];
    ["Offset of field: thread_data::rate_next_io_time"]
        [::std::mem::offset_of!(thread_data, rate_next_io_time) - 189600usize];
    ...
    ["Offset of field: thread_data::last_usec"]
        [::std::mem::offset_of!(thread_data, last_usec) - 189744usize];
    ["Offset of field: thread_data::poisson_state"]
        [::std::mem::offset_of!(thread_data, poisson_state) - 189768usize];
    ["Offset of field: thread_data::io_wq"]
        [::std::mem::offset_of!(thread_data, io_wq) - 189912usize];
    ["Offset of field: thread_data::total_io_size"]
        [::std::mem::offset_of!(thread_data, total_io_size) - 190056usize];
    ["Offset of field: thread_data::fill_device_size"]
        [::std::mem::offset_of!(thread_data, fill_device_size) - 190064usize];
    ["Offset of field: thread_data::io_issues"]
        [::std::mem::offset_of!(thread_data, io_issues) - 190072usize];
    ["Offset of field: thread_data::verify_read_issues"]
        [::std::mem::offset_of!(thread_data, verify_read_issues) - 190096usize];
    ["Offset of field: thread_data::io_issue_bytes"]
        [::std::mem::offset_of!(thread_data, io_issue_bytes) - 190104usize];
    ["Offset of field: thread_data::loops"]
        [::std::mem::offset_of!(thread_data, loops) - 190128usize];
    ["Offset of field: thread_data::inflight_numberio"]
        [::std::mem::offset_of!(thread_data, inflight_numberio) - 190136usize];
    ["Offset of field: thread_data::next_inflight_numberio_idx"][::std::mem::offset_of!(
        thread_data,
        next_inflight_numberio_idx
    ) -
        190144usize];
    ["Offset of field: thread_data::inflight_issued"]
        [::std::mem::offset_of!(thread_data, inflight_issued) - 190152usize];
    ["Offset of field: thread_data::io_blocks"]
        [::std::mem::offset_of!(thread_data, io_blocks) - 190160usize];
    ["Offset of field: thread_data::this_io_blocks"]
        [::std::mem::offset_of!(thread_data, this_io_blocks) - 190184usize];
    ["Offset of field: thread_data::io_bytes"]
        [::std::mem::offset_of!(thread_data, io_bytes) - 190208usize];
    ["Offset of field: thread_data::this_io_bytes"]
        [::std::mem::offset_of!(thread_data, this_io_bytes) - 190232usize];
    ["Offset of field: thread_data::io_skip_bytes"]
        [::std::mem::offset_of!(thread_data, io_skip_bytes) - 190256usize];
    ["Offset of field: thread_data::zone_bytes"]
        [::std::mem::offset_of!(thread_data, zone_bytes) - 190264usize];
    ["Offset of field: thread_data::sem"]
        [::std::mem::offset_of!(thread_data, sem) - 190272usize];
    ["Offset of field: thread_data::bytes_done"]
        [::std::mem::offset_of!(thread_data, bytes_done) - 190280usize];
    ["Offset of field: thread_data::bytes_verified"]
        [::std::mem::offset_of!(thread_data, bytes_verified) - 190304usize];
    ...
    ["Offset of field: thread_data::last_thinktime"]
        [::std::mem::offset_of!(thread_data, last_thinktime) - 190320usize];
    ["Offset of field: thread_data::last_thinktime_blocks"][::std::mem::offset_of!(
        thread_data,
        last_thinktime_blocks
    ) - 190336usize];
    ["Offset of field: thread_data::offset_state"]
        [::std::mem::offset_of!(thread_data, offset_state) - 190344usize];
    ["Offset of field: thread_data::start"]
        [::std::mem::offset_of!(thread_data, start) - 190392usize];
    ["Offset of field: thread_data::epoch"]
        [::std::mem::offset_of!(thread_data, epoch) - 190408usize];
    ["Offset of field: thread_data::alternate_epoch"]
        [::std::mem::offset_of!(thread_data, alternate_epoch) - 190424usize];
    ["Offset of field: thread_data::job_start"]
        [::std::mem::offset_of!(thread_data, job_start) - 190432usize];
    ["Offset of field: thread_data::last_issue"]
        [::std::mem::offset_of!(thread_data, last_issue) - 190440usize];
    ["Offset of field: thread_data::time_offset"]
        [::std::mem::offset_of!(thread_data, time_offset) - 190456usize];
    ["Offset of field: thread_data::ts_cache"]
        [::std::mem::offset_of!(thread_data, ts_cache) - 190464usize];
    ["Offset of field: thread_data::terminate_time"]
        [::std::mem::offset_of!(thread_data, terminate_time) - 190480usize];
    ["Offset of field: thread_data::ts_cache_nr"]
        [::std::mem::offset_of!(thread_data, ts_cache_nr) - 190496usize];
    ["Offset of field: thread_data::ts_cache_mask"]
        [::std::mem::offset_of!(thread_data, ts_cache_mask) - 190500usize];
    ["Offset of field: thread_data::ramp_period_state"]
        [::std::mem::offset_of!(thread_data, ramp_period_state) - 190504usize];
    ["Offset of field: thread_data::latency_ts"]
        [::std::mem::offset_of!(thread_data, latency_ts) - 190512usize];
    ["Offset of field: thread_data::latency_qd"]
        [::std::mem::offset_of!(thread_data, latency_qd) - 190528usize];
    ["Offset of field: thread_data::latency_qd_high"]
        [::std::mem::offset_of!(thread_data, latency_qd_high) - 190532usize];
    ["Offset of field: thread_data::latency_qd_low"]
        [::std::mem::offset_of!(thread_data, latency_qd_low) - 190536usize];
    ["Offset of field: thread_data::latency_failed"]
        [::std::mem::offset_of!(thread_data, latency_failed) - 190540usize];
    ...
    ["Offset of field: thread_data::latency_ios"]
        [::std::mem::offset_of!(thread_data, latency_ios) - 190552usize];
    ["Offset of field: thread_data::latency_end_run"]
        [::std::mem::offset_of!(thread_data, latency_end_run) - 190560usize];
    ["Offset of field: thread_data::rwmix_state"]
        [::std::mem::offset_of!(thread_data, rwmix_state) - 190568usize];
    ["Offset of field: thread_data::rwmix_issues"]
        [::std::mem::offset_of!(thread_data, rwmix_issues) - 190616usize];
    ["Offset of field: thread_data::rwmix_ddir"]
        [::std::mem::offset_of!(thread_data, rwmix_ddir) - 190624usize];
    ["Offset of field: thread_data::ddir_seq_nr"]
        [::std::mem::offset_of!(thread_data, ddir_seq_nr) - 190628usize];
    ["Offset of field: thread_data::seq_rand_state"]
        [::std::mem::offset_of!(thread_data, seq_rand_state) - 190632usize];
    ["Offset of field: thread_data::io_hist_tree"]
        [::std::mem::offset_of!(thread_data, io_hist_tree) - 190776usize];
    ["Offset of field: thread_data::io_hist_list"]
        [::std::mem::offset_of!(thread_data, io_hist_list) - 190784usize];
    ["Offset of field: thread_data::io_hist_len"]
        [::std::mem::offset_of!(thread_data, io_hist_len) - 190800usize];
    ["Offset of field: thread_data::io_log_list"]
        [::std::mem::offset_of!(thread_data, io_log_list) - 190808usize];
    ["Offset of field: thread_data::io_log_rfile"]
        [::std::mem::offset_of!(thread_data, io_log_rfile) - 190824usize];
    ["Offset of field: thread_data::io_log_blktrace"]
        [::std::mem::offset_of!(thread_data, io_log_blktrace) - 190832usize];
    ...
    ["Offset of field: thread_data::io_log_last_ttime"]
        [::std::mem::offset_of!(thread_data, io_log_last_ttime) - 190840usize];
    ["Offset of field: thread_data::io_log_start_time"]
        [::std::mem::offset_of!(thread_data, io_log_start_time) - 190848usize];
    ["Offset of field: thread_data::io_log_current"]
        [::std::mem::offset_of!(thread_data, io_log_current) - 190864usize];
    ["Offset of field: thread_data::io_log_checkmark"]
        [::std::mem::offset_of!(thread_data, io_log_checkmark) - 190868usize];
    ["Offset of field: thread_data::io_log_highmark"]
        [::std::mem::offset_of!(thread_data, io_log_highmark) - 190872usize];
    ["Offset of field: thread_data::io_log_version"]
        [::std::mem::offset_of!(thread_data, io_log_version) - 190876usize];
    ...
    ["Offset of field: thread_data::trim_list"]
        [::std::mem::offset_of!(thread_data, trim_list) - 190896usize];
    ["Offset of field: thread_data::trim_entries"]
        [::std::mem::offset_of!(thread_data, trim_entries) - 190912usize];
    ["Offset of field: thread_data::file_service_nr"]
        [::std::mem::offset_of!(thread_data, file_service_nr) - 190920usize];
    ["Offset of field: thread_data::file_service_left"]
        [::std::mem::offset_of!(thread_data, file_service_left) - 190924usize];
    ["Offset of field: thread_data::file_service_file"]
        [::std::mem::offset_of!(thread_data, file_service_file) - 190928usize];
    ["Offset of field: thread_data::sync_file_range_nr"]
        [::std::mem::offset_of!(thread_data, sync_file_range_nr) - 190936usize];
    ["Offset of field: thread_data::file_size_state"]
        [::std::mem::offset_of!(thread_data, file_size_state) - 190944usize];
    ["Offset of field: thread_data::total_err_count"]
        [::std::mem::offset_of!(thread_data, total_err_count) - 190992usize];
    ["Offset of field: thread_data::first_error"]
        [::std::mem::offset_of!(thread_data, first_error) - 190996usize];
    ["Offset of field: thread_data::flow"]
        [::std::mem::offset_of!(thread_data, flow) - 191000usize];
    ["Offset of field: thread_data::flow_counter"]
        [::std::mem::offset_of!(thread_data, flow_counter) - 191008usize];
    ["Offset of field: thread_data::prof_io_ops"]
        [::std::mem::offset_of!(thread_data, prof_io_ops) - 191016usize];
    ["Offset of field: thread_data::prof_data"]
        [::std::mem::offset_of!(thread_data, prof_data) - 191040usize];
    ["Offset of field: thread_data::pinned_mem"]
        [::std::mem::offset_of!(thread_data, pinned_mem) - 191048usize];
    ["Offset of field: thread_data::ss"]
        [::std::mem::offset_of!(thread_data, ss) - 191056usize];
    ["Offset of field: thread_data::verror"]
        [::std::mem::offset_of!(thread_data, verror) - 191232usize];
};
