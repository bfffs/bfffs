...
pub const FIO_IOOPS_VERSION: u32 = 30;
...
pub type file_lock_mode = libc::c_uint;
...
pub const fio_fallocate_mode_FIO_FALLOCATE_TRUNCATE: fio_fallocate_mode = 5;
...
extern "C" {
    pub fn generic_close_file(
        arg1: *mut thread_data,
        arg2: *mut fio_file,
    ) -> libc::c_int;
}
extern "C" {
    pub fn generic_prepopulate_file(
        arg1: *mut thread_data,
        arg2: *mut fio_file,
    ) -> libc::c_int;
}
...
pub type workqueue_alloc_worker_fn = ::std::option::Option<
...
pub type workqueue_exit_worker_fn = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut submit_worker, arg2: *mut libc::c_uint),
>;
...
pub struct thread_stat {
    ...
    pub groupid: u32,
    pub pid: u32,
    pub description: [libc::c_char; 256usize],
    pub members: u32,
...
pub type error_type = libc::c_uint;
...
pub type fio_zone_mode = libc::c_uint;
...
pub struct thread_options {
    ...
    pub size_nz: libc::c_uint,
    pub io_size_percent: libc::c_uint,
    pub io_size_nz: libc::c_uint,
    ...
    pub start_offset_nz: libc::c_uint,
    ...
    pub zone_capacity: libc::c_ulonglong,
    ...
    pub max_latency: [libc::c_ulonglong; 3usize],
    pub exit_what: libc::c_uint,
    ...
    pub slat_percentiles: libc::c_uint,
    ...
    pub offset_increment_nz: libc::c_uint,
...
pub struct thread_data {
    ...
    pub rate_bytes: [libc::c_ulonglong; 3usize],
