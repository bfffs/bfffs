...
pub const FIO_IOOPS_VERSION: u32 = 37;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ioengine_ops"][::std::mem::size_of::<ioengine_ops>() - 296usize];
    ...
    ["Offset of field: ioengine_ops::move_zone_wp"]
        [::std::mem::offset_of!(ioengine_ops, move_zone_wp) - 240usize];
    ["Offset of field: ioengine_ops::get_max_open_zones"]
        [::std::mem::offset_of!(ioengine_ops, get_max_open_zones) - 248usize];
    ["Offset of field: ioengine_ops::get_max_active_zones"]
        [::std::mem::offset_of!(ioengine_ops, get_max_active_zones) - 256usize];
    ["Offset of field: ioengine_ops::finish_zone"]
        [::std::mem::offset_of!(ioengine_ops, finish_zone) - 264usize];
    ["Offset of field: ioengine_ops::fdp_fetch_ruhs"]
        [::std::mem::offset_of!(ioengine_ops, fdp_fetch_ruhs) - 272usize];
    ["Offset of field: ioengine_ops::option_struct_size"]
        [::std::mem::offset_of!(ioengine_ops, option_struct_size) - 280usize];
    ["Offset of field: ioengine_ops::options"]
        [::std::mem::offset_of!(ioengine_ops, options) - 288usize];
};
...
pub struct thread_options {
    pub _bindgen_opaque_blob: [u64; 438usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_options"]
        [::std::mem::size_of::<thread_options>() - 3504usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of thread_data"][::std::mem::size_of::<thread_data>() - 191184usize];
    ...
    ["Offset of field: thread_data::eo"]
        [::std::mem::offset_of!(thread_data, eo) - 3528usize];
    ["Offset of field: thread_data::thread"]
        [::std::mem::offset_of!(thread_data, thread) - 3536usize];
    ["Offset of field: thread_data::thread_number"]
        [::std::mem::offset_of!(thread_data, thread_number) - 3544usize];
    ["Offset of field: thread_data::subjob_number"]
        [::std::mem::offset_of!(thread_data, subjob_number) - 3548usize];
    ["Offset of field: thread_data::groupid"]
        [::std::mem::offset_of!(thread_data, groupid) - 3552usize];
    ["Offset of field: thread_data::ts"]
        [::std::mem::offset_of!(thread_data, ts) - 3560usize];
    ["Offset of field: thread_data::client_type"]
        [::std::mem::offset_of!(thread_data, client_type) - 187456usize];
    ["Offset of field: thread_data::slat_log"]
        [::std::mem::offset_of!(thread_data, slat_log) - 187464usize];
    ["Offset of field: thread_data::clat_log"]
        [::std::mem::offset_of!(thread_data, clat_log) - 187472usize];
    ["Offset of field: thread_data::clat_hist_log"]
        [::std::mem::offset_of!(thread_data, clat_hist_log) - 187480usize];
    ["Offset of field: thread_data::lat_log"]
        [::std::mem::offset_of!(thread_data, lat_log) - 187488usize];
    ["Offset of field: thread_data::bw_log"]
        [::std::mem::offset_of!(thread_data, bw_log) - 187496usize];
    ["Offset of field: thread_data::iops_log"]
        [::std::mem::offset_of!(thread_data, iops_log) - 187504usize];
    ["Offset of field: thread_data::log_compress_wq"]
        [::std::mem::offset_of!(thread_data, log_compress_wq) - 187512usize];
    ["Offset of field: thread_data::parent"]
        [::std::mem::offset_of!(thread_data, parent) - 187656usize];
    ["Offset of field: thread_data::stat_io_bytes"]
        [::std::mem::offset_of!(thread_data, stat_io_bytes) - 187664usize];
    ["Offset of field: thread_data::bw_sample_time"]
        [::std::mem::offset_of!(thread_data, bw_sample_time) - 187688usize];
    ["Offset of field: thread_data::stat_io_blocks"]
        [::std::mem::offset_of!(thread_data, stat_io_blocks) - 187704usize];
    ["Offset of field: thread_data::iops_sample_time"]
        [::std::mem::offset_of!(thread_data, iops_sample_time) - 187728usize];
    ["Offset of field: thread_data::update_rusage"]
        [::std::mem::offset_of!(thread_data, update_rusage) - 187744usize];
    ["Offset of field: thread_data::rusage_sem"]
        [::std::mem::offset_of!(thread_data, rusage_sem) - 187752usize];
    ["Offset of field: thread_data::ru_start"]
        [::std::mem::offset_of!(thread_data, ru_start) - 187760usize];
    ["Offset of field: thread_data::ru_end"]
        [::std::mem::offset_of!(thread_data, ru_end) - 187904usize];
    ["Offset of field: thread_data::files"]
        [::std::mem::offset_of!(thread_data, files) - 188048usize];
    ["Offset of field: thread_data::file_locks"]
        [::std::mem::offset_of!(thread_data, file_locks) - 188056usize];
    ["Offset of field: thread_data::files_size"]
        [::std::mem::offset_of!(thread_data, files_size) - 188064usize];
    ["Offset of field: thread_data::files_index"]
        [::std::mem::offset_of!(thread_data, files_index) - 188068usize];
    ["Offset of field: thread_data::nr_open_files"]
        [::std::mem::offset_of!(thread_data, nr_open_files) - 188072usize];
    ["Offset of field: thread_data::nr_done_files"]
        [::std::mem::offset_of!(thread_data, nr_done_files) - 188076usize];
    ["Offset of field: thread_data::random_center"]
        [::std::mem::offset_of!(thread_data, random_center) - 188240usize];
    ["Offset of field: thread_data::error"]
        [::std::mem::offset_of!(thread_data, error) - 188248usize];
    ["Offset of field: thread_data::sig"]
        [::std::mem::offset_of!(thread_data, sig) - 188252usize];
    ["Offset of field: thread_data::done"]
        [::std::mem::offset_of!(thread_data, done) - 188256usize];
    ["Offset of field: thread_data::stop_io"]
        [::std::mem::offset_of!(thread_data, stop_io) - 188260usize];
    ["Offset of field: thread_data::pid"]
        [::std::mem::offset_of!(thread_data, pid) - 188264usize];
    ["Offset of field: thread_data::orig_buffer"]
        [::std::mem::offset_of!(thread_data, orig_buffer) - 188272usize];
    ["Offset of field: thread_data::orig_buffer_size"]
        [::std::mem::offset_of!(thread_data, orig_buffer_size) - 188280usize];
    ["Offset of field: thread_data::runstate"]
        [::std::mem::offset_of!(thread_data, runstate) - 188288usize];
    ["Offset of field: thread_data::terminate"]
        [::std::mem::offset_of!(thread_data, terminate) - 188292usize];
    ["Offset of field: thread_data::last_ddir_completed"][::std::mem::offset_of!(
        thread_data,
        last_ddir_completed
    ) - 188296usize];
    ["Offset of field: thread_data::last_ddir_issued"]
        [::std::mem::offset_of!(thread_data, last_ddir_issued) - 188300usize];
    ["Offset of field: thread_data::mmapfd"]
        [::std::mem::offset_of!(thread_data, mmapfd) - 188304usize];
    ["Offset of field: thread_data::iolog_buf"]
        [::std::mem::offset_of!(thread_data, iolog_buf) - 188312usize];
    ["Offset of field: thread_data::iolog_f"]
        [::std::mem::offset_of!(thread_data, iolog_f) - 188320usize];
    ["Offset of field: thread_data::rand_seeds"]
        [::std::mem::offset_of!(thread_data, rand_seeds) - 188328usize];
    ["Offset of field: thread_data::bsrange_state"]
        [::std::mem::offset_of!(thread_data, bsrange_state) - 188504usize];
    ["Offset of field: thread_data::verify_state"]
        [::std::mem::offset_of!(thread_data, verify_state) - 188648usize];
    ...
    ["Offset of field: thread_data::trim_state"]
        [::std::mem::offset_of!(thread_data, trim_state) - 188744usize];
    ["Offset of field: thread_data::delay_state"]
        [::std::mem::offset_of!(thread_data, delay_state) - 188792usize];
    ["Offset of field: thread_data::fdp_state"]
        [::std::mem::offset_of!(thread_data, fdp_state) - 188840usize];
    ["Offset of field: thread_data::buf_state"]
        [::std::mem::offset_of!(thread_data, buf_state) - 188888usize];
    ["Offset of field: thread_data::buf_state_prev"]
        [::std::mem::offset_of!(thread_data, buf_state_prev) - 188936usize];
    ["Offset of field: thread_data::buf_state_ret"]
        [::std::mem::offset_of!(thread_data, buf_state_ret) - 188984usize];
    ["Offset of field: thread_data::dedupe_state"]
        [::std::mem::offset_of!(thread_data, dedupe_state) - 189032usize];
    ["Offset of field: thread_data::zone_state"]
        [::std::mem::offset_of!(thread_data, zone_state) - 189080usize];
    ["Offset of field: thread_data::prio_state"]
        [::std::mem::offset_of!(thread_data, prio_state) - 189128usize];
    ...
    ["Offset of field: thread_data::num_unique_pages"]
        [::std::mem::offset_of!(thread_data, num_unique_pages) - 189232usize];
    ["Offset of field: thread_data::zone_state_index"]
        [::std::mem::offset_of!(thread_data, zone_state_index) - 189240usize];
    ["Offset of field: thread_data::num_write_zones"]
        [::std::mem::offset_of!(thread_data, num_write_zones) - 189248usize];
    ["Offset of field: thread_data::verify_batch"]
        [::std::mem::offset_of!(thread_data, verify_batch) - 189252usize];
    ["Offset of field: thread_data::trim_batch"]
        [::std::mem::offset_of!(thread_data, trim_batch) - 189256usize];
    ["Offset of field: thread_data::trim_verify"]
        [::std::mem::offset_of!(thread_data, trim_verify) - 189260usize];
    ["Offset of field: thread_data::vstate"]
        [::std::mem::offset_of!(thread_data, vstate) - 189264usize];
    ["Offset of field: thread_data::shm_id"]
        [::std::mem::offset_of!(thread_data, shm_id) - 189272usize];
    ["Offset of field: thread_data::ioprio"]
        [::std::mem::offset_of!(thread_data, ioprio) - 189276usize];
    ["Offset of field: thread_data::io_ops"]
        [::std::mem::offset_of!(thread_data, io_ops) - 189280usize];
    ["Offset of field: thread_data::io_ops_init"]
        [::std::mem::offset_of!(thread_data, io_ops_init) - 189288usize];
    ["Offset of field: thread_data::io_ops_data"]
        [::std::mem::offset_of!(thread_data, io_ops_data) - 189296usize];
    ["Offset of field: thread_data::cur_depth"]
        [::std::mem::offset_of!(thread_data, cur_depth) - 189304usize];
    ["Offset of field: thread_data::io_u_queued"]
        [::std::mem::offset_of!(thread_data, io_u_queued) - 189308usize];
    ["Offset of field: thread_data::io_u_in_flight"]
        [::std::mem::offset_of!(thread_data, io_u_in_flight) - 189312usize];
    ["Offset of field: thread_data::io_u_requeues"]
        [::std::mem::offset_of!(thread_data, io_u_requeues) - 189320usize];
    ["Offset of field: thread_data::io_u_freelist"]
        [::std::mem::offset_of!(thread_data, io_u_freelist) - 189344usize];
    ["Offset of field: thread_data::io_u_all"]
        [::std::mem::offset_of!(thread_data, io_u_all) - 189360usize];
    ["Offset of field: thread_data::io_u_lock"]
        [::std::mem::offset_of!(thread_data, io_u_lock) - 189376usize];
    ["Offset of field: thread_data::free_cond"]
        [::std::mem::offset_of!(thread_data, free_cond) - 189384usize];
    ["Offset of field: thread_data::verify_list"]
        [::std::mem::offset_of!(thread_data, verify_list) - 189392usize];
    ["Offset of field: thread_data::verify_threads"]
        [::std::mem::offset_of!(thread_data, verify_threads) - 189408usize];
    ["Offset of field: thread_data::nr_verify_threads"]
        [::std::mem::offset_of!(thread_data, nr_verify_threads) - 189416usize];
    ["Offset of field: thread_data::verify_cond"]
        [::std::mem::offset_of!(thread_data, verify_cond) - 189424usize];
    ["Offset of field: thread_data::verify_thread_exit"]
        [::std::mem::offset_of!(thread_data, verify_thread_exit) - 189432usize];
    ["Offset of field: thread_data::rate_bps"]
        [::std::mem::offset_of!(thread_data, rate_bps) - 189440usize];
    ["Offset of field: thread_data::rate_next_io_time"]
        [::std::mem::offset_of!(thread_data, rate_next_io_time) - 189464usize];
    ...
    ["Offset of field: thread_data::last_usec"]
        [::std::mem::offset_of!(thread_data, last_usec) - 189608usize];
    ["Offset of field: thread_data::poisson_state"]
        [::std::mem::offset_of!(thread_data, poisson_state) - 189632usize];
    ["Offset of field: thread_data::io_wq"]
        [::std::mem::offset_of!(thread_data, io_wq) - 189776usize];
    ["Offset of field: thread_data::total_io_size"]
        [::std::mem::offset_of!(thread_data, total_io_size) - 189920usize];
    ["Offset of field: thread_data::fill_device_size"]
        [::std::mem::offset_of!(thread_data, fill_device_size) - 189928usize];
    ["Offset of field: thread_data::io_issues"]
        [::std::mem::offset_of!(thread_data, io_issues) - 189936usize];
    ["Offset of field: thread_data::verify_read_issues"]
        [::std::mem::offset_of!(thread_data, verify_read_issues) - 189960usize];
    ["Offset of field: thread_data::io_issue_bytes"]
        [::std::mem::offset_of!(thread_data, io_issue_bytes) - 189968usize];
    ["Offset of field: thread_data::loops"]
        [::std::mem::offset_of!(thread_data, loops) - 189992usize];
    ["Offset of field: thread_data::io_blocks"]
        [::std::mem::offset_of!(thread_data, io_blocks) - 190000usize];
    ["Offset of field: thread_data::this_io_blocks"]
        [::std::mem::offset_of!(thread_data, this_io_blocks) - 190024usize];
    ["Offset of field: thread_data::io_bytes"]
        [::std::mem::offset_of!(thread_data, io_bytes) - 190048usize];
    ["Offset of field: thread_data::this_io_bytes"]
        [::std::mem::offset_of!(thread_data, this_io_bytes) - 190072usize];
    ["Offset of field: thread_data::io_skip_bytes"]
        [::std::mem::offset_of!(thread_data, io_skip_bytes) - 190096usize];
    ["Offset of field: thread_data::zone_bytes"]
        [::std::mem::offset_of!(thread_data, zone_bytes) - 190104usize];
    ["Offset of field: thread_data::sem"]
        [::std::mem::offset_of!(thread_data, sem) - 190112usize];
    ["Offset of field: thread_data::bytes_done"]
        [::std::mem::offset_of!(thread_data, bytes_done) - 190120usize];
    ["Offset of field: thread_data::bytes_verified"]
        [::std::mem::offset_of!(thread_data, bytes_verified) - 190144usize];
    ["Offset of field: thread_data::last_write_comp_depth"][::std::mem::offset_of!(
        thread_data,
        last_write_comp_depth
    ) - 190152usize];
    ...
    ["Offset of field: thread_data::last_thinktime"]
        [::std::mem::offset_of!(thread_data, last_thinktime) - 190168usize];
    ...
    ["Offset of field: thread_data::random_state"]
        [::std::mem::offset_of!(thread_data, random_state) - 190192usize];
    ["Offset of field: thread_data::start"]
        [::std::mem::offset_of!(thread_data, start) - 190240usize];
    ["Offset of field: thread_data::epoch"]
        [::std::mem::offset_of!(thread_data, epoch) - 190256usize];
    ["Offset of field: thread_data::alternate_epoch"]
        [::std::mem::offset_of!(thread_data, alternate_epoch) - 190272usize];
    ["Offset of field: thread_data::job_start"]
        [::std::mem::offset_of!(thread_data, job_start) - 190280usize];
    ["Offset of field: thread_data::last_issue"]
        [::std::mem::offset_of!(thread_data, last_issue) - 190288usize];
    ["Offset of field: thread_data::time_offset"]
        [::std::mem::offset_of!(thread_data, time_offset) - 190304usize];
    ["Offset of field: thread_data::ts_cache"]
        [::std::mem::offset_of!(thread_data, ts_cache) - 190312usize];
    ["Offset of field: thread_data::terminate_time"]
        [::std::mem::offset_of!(thread_data, terminate_time) - 190328usize];
    ["Offset of field: thread_data::ts_cache_nr"]
        [::std::mem::offset_of!(thread_data, ts_cache_nr) - 190344usize];
    ["Offset of field: thread_data::ts_cache_mask"]
        [::std::mem::offset_of!(thread_data, ts_cache_mask) - 190348usize];
    ["Offset of field: thread_data::ramp_time_over"]
        [::std::mem::offset_of!(thread_data, ramp_time_over) - 190352usize];
    ["Offset of field: thread_data::latency_ts"]
        [::std::mem::offset_of!(thread_data, latency_ts) - 190360usize];
    ["Offset of field: thread_data::latency_qd"]
        [::std::mem::offset_of!(thread_data, latency_qd) - 190376usize];
    ["Offset of field: thread_data::latency_qd_high"]
        [::std::mem::offset_of!(thread_data, latency_qd_high) - 190380usize];
    ["Offset of field: thread_data::latency_qd_low"]
        [::std::mem::offset_of!(thread_data, latency_qd_low) - 190384usize];
    ["Offset of field: thread_data::latency_failed"]
        [::std::mem::offset_of!(thread_data, latency_failed) - 190388usize];
    ...
    ["Offset of field: thread_data::latency_ios"]
        [::std::mem::offset_of!(thread_data, latency_ios) - 190400usize];
    ["Offset of field: thread_data::latency_end_run"]
        [::std::mem::offset_of!(thread_data, latency_end_run) - 190408usize];
    ["Offset of field: thread_data::rwmix_state"]
        [::std::mem::offset_of!(thread_data, rwmix_state) - 190416usize];
    ["Offset of field: thread_data::rwmix_issues"]
        [::std::mem::offset_of!(thread_data, rwmix_issues) - 190464usize];
    ["Offset of field: thread_data::rwmix_ddir"]
        [::std::mem::offset_of!(thread_data, rwmix_ddir) - 190472usize];
    ["Offset of field: thread_data::ddir_seq_nr"]
        [::std::mem::offset_of!(thread_data, ddir_seq_nr) - 190476usize];
    ["Offset of field: thread_data::seq_rand_state"]
        [::std::mem::offset_of!(thread_data, seq_rand_state) - 190480usize];
    ["Offset of field: thread_data::io_hist_tree"]
        [::std::mem::offset_of!(thread_data, io_hist_tree) - 190624usize];
    ["Offset of field: thread_data::io_hist_list"]
        [::std::mem::offset_of!(thread_data, io_hist_list) - 190632usize];
    ["Offset of field: thread_data::io_hist_len"]
        [::std::mem::offset_of!(thread_data, io_hist_len) - 190648usize];
    ["Offset of field: thread_data::io_log_list"]
        [::std::mem::offset_of!(thread_data, io_log_list) - 190656usize];
    ["Offset of field: thread_data::io_log_rfile"]
        [::std::mem::offset_of!(thread_data, io_log_rfile) - 190672usize];
    ["Offset of field: thread_data::io_log_blktrace"]
        [::std::mem::offset_of!(thread_data, io_log_blktrace) - 190680usize];
    ...
    ["Offset of field: thread_data::io_log_last_ttime"]
        [::std::mem::offset_of!(thread_data, io_log_last_ttime) - 190688usize];
    ["Offset of field: thread_data::io_log_start_time"]
        [::std::mem::offset_of!(thread_data, io_log_start_time) - 190696usize];
    ["Offset of field: thread_data::io_log_current"]
        [::std::mem::offset_of!(thread_data, io_log_current) - 190712usize];
    ["Offset of field: thread_data::io_log_checkmark"]
        [::std::mem::offset_of!(thread_data, io_log_checkmark) - 190716usize];
    ["Offset of field: thread_data::io_log_highmark"]
        [::std::mem::offset_of!(thread_data, io_log_highmark) - 190720usize];
    ["Offset of field: thread_data::io_log_version"]
        [::std::mem::offset_of!(thread_data, io_log_version) - 190724usize];
    ...
    ["Offset of field: thread_data::trim_list"]
        [::std::mem::offset_of!(thread_data, trim_list) - 190744usize];
    ["Offset of field: thread_data::trim_entries"]
        [::std::mem::offset_of!(thread_data, trim_entries) - 190760usize];
    ["Offset of field: thread_data::file_service_nr"]
        [::std::mem::offset_of!(thread_data, file_service_nr) - 190768usize];
    ["Offset of field: thread_data::file_service_left"]
        [::std::mem::offset_of!(thread_data, file_service_left) - 190772usize];
    ["Offset of field: thread_data::file_service_file"]
        [::std::mem::offset_of!(thread_data, file_service_file) - 190776usize];
    ["Offset of field: thread_data::sync_file_range_nr"]
        [::std::mem::offset_of!(thread_data, sync_file_range_nr) - 190784usize];
    ["Offset of field: thread_data::file_size_state"]
        [::std::mem::offset_of!(thread_data, file_size_state) - 190792usize];
    ["Offset of field: thread_data::total_err_count"]
        [::std::mem::offset_of!(thread_data, total_err_count) - 190840usize];
    ["Offset of field: thread_data::first_error"]
        [::std::mem::offset_of!(thread_data, first_error) - 190844usize];
    ["Offset of field: thread_data::flow"]
        [::std::mem::offset_of!(thread_data, flow) - 190848usize];
    ["Offset of field: thread_data::flow_counter"]
        [::std::mem::offset_of!(thread_data, flow_counter) - 190856usize];
    ["Offset of field: thread_data::prof_io_ops"]
        [::std::mem::offset_of!(thread_data, prof_io_ops) - 190864usize];
    ["Offset of field: thread_data::prof_data"]
        [::std::mem::offset_of!(thread_data, prof_data) - 190888usize];
    ["Offset of field: thread_data::pinned_mem"]
        [::std::mem::offset_of!(thread_data, pinned_mem) - 190896usize];
    ["Offset of field: thread_data::ss"]
        [::std::mem::offset_of!(thread_data, ss) - 190904usize];
    ["Offset of field: thread_data::verror"]
        [::std::mem::offset_of!(thread_data, verror) - 191056usize];
};
