...
pub const FIO_IOOPS_VERSION: u32 = 29;
...
pub struct thread_stat {
    pub _bindgen_opaque_blob: [u64; 34158usize],
}
#[repr(C)]
#[repr(align(4))]
#[derive(Copy, Clone)]
